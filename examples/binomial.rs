//! This example implements one of the core ingredients in combinatorics: the
//! __binomial coefficient__. It is done utilizing _Pascal's Triangle_, which
//! basically is the _inductive definition_ of binomial coefficients.
...
mod tests {
    ...
    pub fn test_mpint_binom() {
        ...
        // test pascal's triangle boundaries
